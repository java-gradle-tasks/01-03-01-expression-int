...
public class MyNumberOfStudentStudentClassNumberZero {
   ...
   public void test() {
      ...
      String expected="Teljessen feltoltott osztalyok szama:0"+newLine;
      ...
      Assertions.assertTrue(found,"Amikor a letszam pont elfer egy-egy osztalyban rosszul hatarozta meg az osztalyok szamat!");
   }
}
