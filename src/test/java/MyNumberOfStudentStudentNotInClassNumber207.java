...
public class MyNumberOfStudentStudentNotInClassNumber207 {
   ...
   public void test() {
      ...
      String expected="A nem feltoltott osztalyba felveheto diakok szama:1"+newLine;
