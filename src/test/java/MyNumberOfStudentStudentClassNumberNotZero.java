...
import java.io.PrintStream;
   ...
   public class MyNumberOfStudentStudentClassNumberNotZero {
      ...
      public void test() {
         ...
         String expected="Teljessen feltoltott osztalyok szama:4"+newLine;
         ...
         Assertions.assertTrue(found,"Amikor kimarad diak egy csonka osztalyba, rosszul hatarozta meg az osztalyok szamat!");
      }
   }
